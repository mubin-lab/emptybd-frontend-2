...
// It starts with: {/* Group Info Modal */}\n              {showGroupInfoModal && activeConversation?.isGroup && (\n                <div className="absolute top-0 left-0...
const wrapperStartRegex = /\{\/\* Group Info Modal \*\/\}\n\s*\{showGroupInfoModal && activeConversation\?\.isGroup && \(\n/;
modalContent = modalContent.replace(wrapperStartRegex, '');
// It ends with: \n              )}
modalContent = modalContent.replace(/\s*\)\}\n*$/, '');

// Modify absolute positioning to flex-1 relative
...
console.log("Modal rearranged correctly!");
