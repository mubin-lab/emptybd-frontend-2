...
if (modalStartIdx === -1 || content.indexOf(modalEndMarker, modalStartIdx) === -1) {
  console.error("COULD NOT FIND MODAL BOUNDS EXACTLY");
  process.exit(1);
}
...
if (msgStartIdx === -1 || content.indexOf(inputEndMarker, msgStartIdx) === -1) {
  console.error("COULD NOT FIND MESSAGE/INPUT BOUNDS EXACTLY");
  process.exit(1);
}
