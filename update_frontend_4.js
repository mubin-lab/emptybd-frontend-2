...
if (!content.includes('const [stagedGroupMembers')) {
...
if (startIdx !== -1 && content.indexOf(endIdxStr, startIdx) !== -1) {
  content = content.substring(0, startIdx) + newAddMemberFuncs + content.substring(endIdx);
} else {
  console.log("Could not find function bounds exactly.");
}
...
console.log("Updated frontend correctly!");
