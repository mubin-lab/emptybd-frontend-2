...
import PermissionOnboardingModal from "@/components/shared/PermissionOnboardingModal";
import PhotoOnboardingModal from "@/components/shared/PhotoOnboardingModal";
import UserOnboardingTour from "@/components/shared/UserOnboardingTour";
import GuestOnboardingTour from "@/components/shared/GuestOnboardingTour";
...
const MainLayout = ({ children }: { children: ReactNode }) => {
  ...
  if (!loading && user?.role === "suspend" && pathname !== "/support") {
    return (
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="py-0 lg:py-6">
        <div className="lg:hidden py-0">{isMenuPage && <HeroSection />}</div>
      </div>
