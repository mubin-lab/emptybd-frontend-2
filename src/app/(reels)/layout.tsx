...
export default function ReelsLayout({
  ...
  return (
    <div className="relative bg-black min-h-screen text-white overflow-hidden">
      ...
      <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50 flex items-center bg-gray-950/80 backdrop-blur-xl rounded-full border border-gray-800/60 p-1 shadow-2xl">
        <Link
          href="/reels"
          className={`px-4 lg:px-6 py-1 lg:py-2 rounded-full text-xs lg:text-sm font-bold transition-all ${
            pathname === "/reels"
